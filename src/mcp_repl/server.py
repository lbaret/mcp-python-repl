...
def execute_python_code(code: str) -> str:
    ...
    - **Data Access:** You can access, read, and manipulate documents stored in the `/app/data`
      folder. Use standard Python libraries (like `os`, `pathlib`, etc.) to interact with
      these files.
